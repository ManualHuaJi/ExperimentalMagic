...
public class CardFlux extends TheorycraftCard {
    ...
    ItemStack options[] = new ItemStack[]{new ItemStack(ThaumcraftApiHelper.makeCrystal(this.aspect).getItem()), new ItemStack(ItemPhial.makeFilledPhial(this.aspect).getItem())};
