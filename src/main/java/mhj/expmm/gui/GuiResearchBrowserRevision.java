...
public class GuiResearchBrowserRevision extends GuiScreen {
    ...
    GuiResearchBrowserRevision instance = null;
    long t = 0L;
    long popuptime = 0L;
    String popupmessage = "";
    ...
    public GuiResearchBrowserRevision() {
    ...
    public GuiResearchBrowserRevision(double x, double y) {
    ...
    private void genResearchBackgroundFixedPost(int mx, int my, float par3, int locX, int locY) {
        ...
        if (this.currentHighlight != null) {
            ...
            if (this.currentHighlight.getCategory().equals(ExperimentalMagic.MODID.toUpperCase())) {
