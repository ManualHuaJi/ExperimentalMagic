...
public class GuiAdvResearchTable extends GuiContainer {
    private float xSize_lo;
    private float ySize_lo;
    private TileAdvancedResearchTable table;
    ...
    public GuiAdvResearchTable(final EntityPlayer player, final TileAdvancedResearchTable e) {
        ...
        this.buttonCreate = new GuiImageButton((GuiScreen) this, 1, this.guiLeft + 128, this.guiTop + 22, 49, 11, "button.create.theory", null, this.txBase, 37, 66, 51, 13, 8978346);
        this.buttonComplete = new GuiImageButton((GuiScreen) this, 7, this.guiLeft + 191, this.guiTop + 96, 49, 11, "button.complete.theory", null, this.txBase, 37, 66, 51, 13, 8978346);
        this.buttonScrap = new GuiImageButton((GuiScreen) this, 9, this.guiLeft + 128, this.guiTop + 168, 49, 11, "button.scrap.theory", null, this.txBase, 37, 66, 51, 13, 16720418);
    ...
    public void drawScreen(final int mx, final int my, final float par3) {
        ...
        if (this.table.data == null) {
            ...
            if (this.table.getStackInSlot(0) == null || this.table.getStackInSlot(0).isEmpty() || this.table.getStackInSlot(0).getItemDamage() == this.table.getStackInSlot(0).getMaxDamage()) {
                ...
                UtilsFX.drawCustomTooltip((GuiScreen) this, this.fontRenderer, Arrays.asList(I18n.translateToLocal("tile.researchtable.noink.0"), I18n.translateToLocal("tile.researchtable.noink.1")), xx - sx + 116, yy + 60 + qq, 11, true);
                qq += 40;
            }
            if (this.table.getStackInSlot(1) == null || this.table.getStackInSlot(1).isEmpty()) {
                ...
                UtilsFX.drawCustomTooltip((GuiScreen) this, this.fontRenderer, Arrays.asList(I18n.translateToLocal("tile.researchtable.nopaper.0")), xx - sx + 116, yy + 60 + qq, 11, true);
            }
        }
    ...
    protected void drawGuiContainerBackgroundLayer(final float partialTicks, final int mx, final int my) {
        ...
        if (this.table.data == null) {
            ...
            Map<String, Integer> sortedMap = (Map) unsortedMap.entrySet().stream().sorted(valueComparator).collect(Collectors.toMap(Map.Entry::getKey, Map.Entry::getValue, (e1, e2) -> e1, java.util.LinkedHashMap::new));
            GL11.glEnable(3042);
            GL11.glBlendFunc(770, 771);
            int i = 0;
            for (final String field : sortedMap.keySet()) {
                ...
                if (var9 >= 0 && var10 >= 0 && var9 < 16 && var10 < 16) {
                    GL11.glPushMatrix();
                    UtilsFX.drawCustomTooltip((GuiScreen) this, this.fontRenderer, Arrays.asList(ResearchCategories.getCategoryName(field)), mx + 8, my + 8, 11);
                    GL11.glPopMatrix();
                    RenderHelper.disableStandardItemLighting();
                }
                ++i;
            ...
            for (int a = 0; a < items.length; ++a) {
                if (this.isPointInRegion((int) (x - 9 * items.length + 18 * a), (int) (y + 36.0), 15, 15, mx, my)) {
                    if (items[a] == null || items[a].isEmpty()) {
                        this.drawHoveringText((List) Arrays.asList(I18n.translateToLocal("tc.card.unknown")), mx, my);
                    } else {
    ...
    protected void actionPerformed(final GuiButton button) throws IOException {
        if (button.id == 1) {
            ...
            PacketLoader.INSTANCE.sendToServer(new PacketStartTheoryToServerART(this.table.getPos(), this.selectedAids));
        } else if (button.id == 7) {
            this.playButtonClick();
