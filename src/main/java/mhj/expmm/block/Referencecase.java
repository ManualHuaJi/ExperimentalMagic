...
import mhj.expmm.tile.TileReferenceBookcase;
 ...
 * @Author: ManualHuaJi
 */
public class Referencecase extends BlockEXPMMTile implements ITheorycraftAid, ITileEntityProvider {
    public static final Referencecase instance = new Referencecase();
